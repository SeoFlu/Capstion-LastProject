...
public class CommuntiyActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    FirebaseDatabase database = FirebaseDatabase.getInstance();
    DatabaseReference communityBoard = database.getReference("community1");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("수업 평가_엑티비티");
        setSupportActionBar(toolbar);
        FloatingActionButton fab = findViewById(R.id.fab);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent commitCommunutiyIntent = new Intent(CommuntiyActivity.this,WriteCommnuityActivity.class);
                commitCommunutiyIntent.putExtra("boardNum",1);
    ...
    private void displayNotice(List<BoardMenu> boardMenuList){
        ...
        boardListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                DatabaseReference communityBoardModify = database.getReference("community1/"+boardMenu.getBoardKey());
                communityBoardModify.setValue(boardMenu);
                Intent detailIntent = new Intent(view.getContext(),DetailActivity.class);
                detailIntent.putExtra("boardNum",1);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_community1) {
            ...
            Intent intent = new Intent(CommuntiyActivity.this,CommunityActivity2.class);
            startActivity(intent);
            finish();
        } else if (id == R.id.nav_community3) {
            Intent intent = new Intent(CommuntiyActivity.this,CommunityActivity3.class);
            startActivity(intent);
            finish();
        }
