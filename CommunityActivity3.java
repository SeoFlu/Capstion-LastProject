...
public class CommunityActivity3 extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {
    FirebaseDatabase database = FirebaseDatabase.getInstance();
    DatabaseReference communityBoard = database.getReference("community3");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("자유게시판 _ 엑티비티 3");
        setSupportActionBar(toolbar);
        FloatingActionButton fab = findViewById(R.id.fab);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent commitCommunutiyIntent = new Intent(CommunityActivity3.this,WriteCommnuityActivity.class);
                commitCommunutiyIntent.putExtra("boardNum",3);
...
//                boardList.add(boardMenu);
    ...
    private void displayNotice(List<BoardMenu> boardMenuList){
        ...
        boardListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                DatabaseReference communityBoardModify = database.getReference("community3/"+boardMenu.getBoardKey());
                communityBoardModify.setValue(boardMenu);
                Intent detailIntent = new Intent(view.getContext(),DetailActivity.class);
                detailIntent.putExtra("boardNum",3);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_community1) {
            Intent intent = new Intent(CommunityActivity3.this,CommuntiyActivity.class);
            startActivity(intent);
            finish();
        } else if (id == R.id.nav_community2) {
            Intent intent = new Intent(CommunityActivity3.this,CommunityActivity2.class);
            startActivity(intent);
            finish();
        } else if (id == R.id.nav_community3) {
            Intent intent = new Intent(CommunityActivity3.this,CommunityActivity3.class);
            startActivity(intent);
            finish();
        }
